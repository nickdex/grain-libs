...
[`auth.allium`](libs/auth/src/nickdex/grain/auth/auth.allium) — read that first if you
...
Mount five handlers, at [`default-ceremony-paths`](libs/auth/src/nickdex/grain/auth/script.clj)
